...
class AdminController:
    ...
    def validate_user_update(self, user: User, current_username: str, 
                           new_password: str, confirm_password: str,
                           new_role: str, new_is_active: bool) -> Tuple[bool, str]:
    ...
    def update_user(self, user: User, email_str: str, password: str, 
                   role: str, is_active: bool) -> Tuple[bool, str]:
        try:
