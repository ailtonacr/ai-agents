...
def _render_user_actions_section(admin_controller: AdminController, users, user_session_controller: UserSessionController) -> None:
...
def _render_action_buttons(admin_controller: AdminController, selected_user, form_data: dict, user_session_controller: UserSessionController) -> None:
...
def _handle_update_confirmation(admin_controller: AdminController, selected_user, form_data: dict, user_session_controller: UserSessionController) -> None:
    ...
    if confirm_col1.button('Sim, salvar', key='confirm_update_yes'):
        ...
        is_valid, error_msg = admin_controller.validate_user_update(
            ...
            form_data['role'], form_data['is_active']
        )
        ...
        if not is_valid:
            ...
            success, message = admin_controller.update_user(
                selected_user, form_data['email'], form_data['password'],
                form_data['role'], form_data['is_active']
            )
...
def _handle_delete_confirmation(admin_controller: AdminController, selected_user, user_session_controller: UserSessionController) -> None:
